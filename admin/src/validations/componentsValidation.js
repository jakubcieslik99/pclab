const saveComponentErrors = {
  componentTitle: {
    ...
    maxLength: {
      value: 60,
      message: 'Maksymalna długość tytułu to 60 znaków.',
    },
  },
  componentURL: {
    required: {
  ...
  componentPrice: {
    ...
    maxLength: {
      value: 8,
      message: 'Maksymalna wartość ceny to 99999.99.',
    },
    pattern: {
      value: /^([0-9]+[.][0-9]{2})$/,
  ...
  componentAmount: {
    ...
    maxLength: {
      value: 3,
      message: 'Maksymalna ilość sztuk to 999.',
    },
    pattern: {
      value: /^([0-9]+)$/,
      message: 'Niepoprawny format ilości sztuk.',
    },
  },
}
